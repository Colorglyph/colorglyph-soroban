...
# initialize
soroban contract invoke --id $contract_id --source default --network testnet -- initialize --token_address $token_address --fee_address $fee_address --owner_address default
